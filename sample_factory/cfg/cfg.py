...
def add_sol_args(p: ArgumentParser):
    """Scalable Option Learning (SOL) arguments."""
    p.add_argument("--with_sol", default=False, type=str2bool, help="Uses hierarchical rather than flat agent. ")
    p.add_argument("--with_flat_intrinsic_rewards", default=False, type=str2bool, help="Uses flat agent with intrinsic rewards added.")
    p.add_argument(
        "--sol_option_rewards",
        default='',
        type=str,
    ...
    p.add_argument(
        ...
        default='',
        type=str,
        help="Name of the reward function the controller optimizes.",
    )    
    p.add_argument(
        "--sol_controller_reward_scale",
        default=1.0,
        type=float,
        help="Controller reward scaling.",
    )
    p.add_argument(
        "--sol_controller_exploration_scale",
        default=1.0,
        type=float,
    ...
    p.add_argument(
        ...
        default=8,
        type=int,
        help="Number of option lengths to choose from.",
    )
    p.add_argument(
        "--sol_min_option_length",
        default=1,
        type=int,
        help="Minimum option length.",
    )
    p.add_argument(
        "--sol_options_to_add_llm_reward",
        default='0',
        type=str,
        help="Which option(s) to add LLM reward to. Format is comma-separated ints. This will only do something if llm_reward_type is set.",
    )
    p.add_argument(
        "--sol_bootstrap_on_option_switch",
        default=True,
        type=str2bool,
    ...
    p.add_argument(
        ...
        default="discrete",
        type=str,
        help="discrete | multidiscrete | continuous"
    )
    p.add_argument(
...
def add_llm_reward_args(p: ArgumentParser):
    ...
    p.add_argument(
        ...
        default='none',
        type=str,
        help="Currently supported: none | motif",
    )        
    p.add_argument(
        "--llm_reward_coeff",
        default=0.1,
        type=float,
        help="Weight for LLM reward coefficient.",
    )        
    p.add_argument(
        "--motif_reward_dir",
        default='',
        type=str,
        help="Where Motif reward model is saved.",
    )    
    p.add_argument(
        "--motif_checkpoint_num",
        default=0,
        type=int,
        help="Where Motif reward model is saved.",
    )    
    p.add_argument(
        "--motif_eps_threshold_quantile",
        default=0.5,
        type=float,
        help="Where Motif reward model is saved.",
    )    
    p.add_argument(
        "--motif_beta_count_exponent",
        default=3,
        type=int,
