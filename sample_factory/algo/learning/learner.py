...
from sol.sol_vtrace import compute_vtrace_sol
from sol.controller_reward_computation import compute_controller_reward_sums_cython
        ...
        with torch.no_grad(), self.timing.add_time("advantages_returns"):
            if self.cfg.with_vtrace:
                ...
                if self.cfg.with_sol:
                    ...
                    # this requires some FOR loops which we compile to Cython. 
            ...
            if self.cfg.with_sol:
                for p in range(num_policies):
                    ...
                    if policy_mask.sum() > 1:
                        ...
                        # if we don't handle this edge case, adv_std=nan which causes errors
                        adv[policy_mask] = 0
            else:
