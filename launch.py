...
def main():
    ...
    ARGS_DICT.update({'wandb_user': args.wandb_user})
    ...
    if 'nethack' in env_name or 'minihack' in env_name:
        if args.num_gpus == 1:
            ...
            BASE_CMD = f'torchrun --nnodes=1 --nproc_per_node={args.num_gpus} sf_examples/nethack/train_nethack.py --use_ddp True --num_gpus_for_ddp {args.num_gpus}'
        ...
        NUM_GPUS = 1
    elif 'craftium' in env_name:
        BASE_CMD = 'python -m sf_examples.craftium.train_craftium'
        # use 8 GPUs: 7 for env rendering, 1 for RL
        NUM_GPUS = 8
        args.script = 'single_node_craftium_template.sbatch'
    else:
